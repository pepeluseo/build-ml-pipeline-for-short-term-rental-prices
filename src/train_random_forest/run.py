...
def go(args):
    ...
    ######################################
    # Download train and validation artifact from W&B
    ######################################
    logger.info("Downloading trainval artifact: %s", args.trainval_artifact)
    ...
    ######################################
    # Save the sklearn pipeline as an MLflow model
    ######################################
...
def get_inference_pipeline(rf_config, max_tfidf_features):
    ...
    # Note that we do not scale because Random Forest does not need that.
    zero_imputed = [
        "minimum_nights",
        "number_of_reviews",
        "reviews_per_month",
    ...
    # Minimal feature engineering step:
